...
set -g window-status-format "#[fg=#404452]#I:#[fg=#bfc1bf]#W#F"
set -g window-status-current-format "#[fg=#a4b8cd]#I:#[fg=#f5f6f6]#W#F"
set -g window-status-separator "#[fg=#2b2d37]󰇝"
